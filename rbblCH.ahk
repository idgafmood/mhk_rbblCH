...
_.start({"packageName":"rbblCH", "version":"1", "url":"https://raw.githubusercontent.com/idgafmood/mhk_rbblCH/main/rbblCH.as", "passwordProtected":"0"})
global $:=_.params({"1_toggle":"$^1"})
{
    CHInit()


    _.hotkey("$*~",$.1_toggle,"main")
} return
...
CHInit() {
    static
    static 十字线, 十字线hwnd, static
    ;/十字线
        gui, % "十字线:+hwnd十字线hwnd +LastFound -caption -sysmenu +E0x20 +AlwaysOnTop" ;+E0x08000000 -caption -sysmenu
        gui, % "十字线:color", % "0x000000",  % "0x000000"
        gui, % "十字线:font", % "s12 q4 w1", % "Consolas"
        gui, % "十字线:Margin", % "0", % "0"
        winset, % "TransColor", % "000000"
        gui, % "十字线:Add", % "progress", % "w0 h470 x0 y0 disabled BACKGROUND000000"
        gui, % "十字线:Add", % "ActiveX", % "xP+35 y+0 w100 h600 disabled +0x4000000 vpic", htmlfile
        pic.Write("<body style='margin: 0; overflow: hidden;'><div class='image'><img class='background-image' src='https://github.com/idgafmood/mhk_rbblCH/releases/download/`%2B/crosses4.png' style='width: 100%; height:100%;'></div></body>")
        ;gui, % "十字线:Add", % "progress", % "w26 h0 x+0 yP+0 disabled BACKGROUND000000" ;16
        gui, % "十字线:show", % "center", % ""
    return
}
